...
export const Testimonials: React.FC = () => {
  ...
  return (
    <section className="py-20 px-4 bg-slate-100 border-t border-slate-200" style={{ marginTop: "-40px" }}>
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-5 text-slate-900">
          Kisah Sukses Pengguna
        </h2>
        <p className="text-lg text-center text-slate-700 mb-12 max-w-3xl mx-auto">
          Sudah banyak praktisi hukum terbantu. <span className="text-orange-600 font-semibold">Simak hasil nyata mereka!</span>
        </p>
        ...
        <div className="relative">
          <div
            ref={sliderRef}
            className="relative overflow-hidden rounded-2xl bg-slate-200 shadow-lg"
