  ...
  const results = [
    {
      ...
      title: 'Visualisasi Kasus Interaktif',
      description: 'Buat peta konsep hukum yang jelas dan profesional untuk memvisualisasikan hubungan antar bukti, pasal, dan klausa. Presentasikan kasus Anda dengan visual yang memukau di pengadilan atau meeting klien.',
      icon: 'fas fa-project-diagram'
    },
    {
      image: '/results/ppt.avif',
      title: 'Slide Presentasi Legal Otomatis',
      description: 'Generate slide presentasi profesional langsung dari dokumen hukum Anda. Tidak perlu lagi menghabiskan waktu berjam-jam untuk membuat slide—NotebookLM melakukannya untuk Anda dengan sitasi yang jelas.',
      icon: 'fas fa-presentation'
    },
    {
      image: '/results/tabel.avif',
      title: 'Tabel Analisis Dokumen Hukum',
      description: 'Ekstrak dan analisis data dari berbagai dokumen hukum menjadi tabel yang terstruktur. Bandingkan klausa, identifikasi pola, dan temukan bukti penting dengan lebih mudah untuk memperkuat argumentasi Anda.',
      icon: 'fas fa-table'
    }
  ];
