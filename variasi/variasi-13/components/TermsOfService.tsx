      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6 bg-white p-6 md:p-8 rounded-2xl shadow-lg">
          ...
          <section>
            ...
            <p>Materi yang disampaikan dalam webinar ini bertujuan untuk edukasi dan pengembangan profesional dalam penggunaan NotebookLM. Hasil akhir (peningkatan produktivitas dan efisiensi kerja) sangat bergantung pada implementasi praktis, konsistensi penggunaan, dan karakteristik dokumen yang ditangani. Kami tidak menjamin hasil tertentu, namun kami mengajarkan metodologi terbaik untuk meningkatkan efektivitas penggunaan NotebookLM Anda.</p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">5. Kerahasiaan Data</h2>
            <p>Peserta diharapkan untuk tidak membagikan informasi rahasia atau data sensitif selama sesi webinar. Kami berkomitmen menjaga kerahasiaan, namun peserta bertanggung jawab penuh atas informasi yang mereka bagikan.</p>
          </section>
        </div>
      </div>
    </div>
