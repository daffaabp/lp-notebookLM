  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Content */}
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6 bg-white p-6 md:p-8 rounded-2xl shadow-lg">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">2. Penggunaan Informasi</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">4. Data NotebookLM</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">5. Cookie dan Teknologi Pelacakan</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">6. Hak Anda</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">7. Perubahan Kebijakan</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">8. Kontak</h2>
            <p>Jika Anda memiliki pertanyaan tentang kebijakan privasi ini, silakan hubungi kami di <a href="https://kelasinovatif.com" className="text-blue-600 hover:text-blue-800 underline">kelasinovatif.com</a></p>
          </section>
        </div>
      </div>
    </div>
