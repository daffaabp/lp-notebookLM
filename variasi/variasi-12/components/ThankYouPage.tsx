...
<<<<<<< HEAD
                        className="inline-flex items-center gap-2 px-8 py-4 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-full transition-all transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl font-sans"
=======
                        className="inline-flex items-center gap-2 px-8 py-4 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-lg transition-all transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl font-sans"
>>>>>>> f59101d12568799a1c02434766eccfd7a7cc03ba
                    >
