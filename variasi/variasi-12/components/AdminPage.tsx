...
import { Loader2, Users, AlertCircle, CheckCircle, LogOut } from 'lucide-react';
...
const AdminPage: React.FC = () => {
    ...
    const performLogin = async (u: string, p: string) => {
        ...
        try {
            ...
            console.error(error);
            // Only alert if it's a manual login attempt (loading state is true and credential exists)
            // But here we rely on the caller or just alert.
            // For auto-login, we silently fail (and logout).
        } finally {
            setIsLoading(false);
        }
    };
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-sm">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-blue-600 text-white py-3 rounded-lg font-bold hover:bg-blue-700 transition-colors disabled:opacity-70"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="p-6 border-b border-gray-100">
                            ...
                            <p className="text-sm text-gray-400 mt-1">Track commissions and payouts.</p>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="p-6 border-b border-gray-100">
                            ...
                            <p className="text-sm text-gray-400 mt-1">Referrals with pending payments.</p>
                        </div>
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm">
                                <thead className="bg-gray-50 text-gray-600 font-semibold">
