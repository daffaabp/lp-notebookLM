    ...
    <section className="py-24 px-4 bg-slate-50">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-16">
        <div className="relative">
          <div className="absolute -inset-4 bg-teal-500 rounded-full blur-xl opacity-30 animate-pulse"></div>
          <img 
        ...
        <div className="text-center md:text-left">
          <h3 className="text-3xl font-black text-teal-900 mb-2 uppercase">M. Arianto</h3>
          <p className="text-teal-600 font-black mb-6 text-lg">AI Engineer dan Researcher</p>
