...
export const MidCTA: React.FC<MidCTAProps> = ({ onRegisterClick }) => {
  return (
    <section className="py-16 legal-gradient text-white text-center px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
      <div className="max-w-4xl mx-auto relative z-10">
        <h3 className="text-2xl md:text-3xl font-black mb-8 leading-snug text-white uppercase">
          Otomatiskan Review Jurnal Medis Anda<br className="hidden md:block" />
          Temukan Fakta, Sitasi & Insight dalam Sekejap!
        </h3>
